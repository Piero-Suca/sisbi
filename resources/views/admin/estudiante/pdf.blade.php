    ...
    <div class="container">
        ...
        <thead>
                <tr>
                    ...
                    <th class="center" style="font-weight:bold; border:1px solid #1d1d1d;background-color: #03a9f4;color:#fff" width="5%">Programa</th>
                    <th class="center" style="font-weight:bold; border:1px solid #1d1d1d;background-color: #03a9f4;color:#fff" width="5%">semestre</th>
            ...
            <tbody class="contenidoprincipal">
                @foreach ($estudiante as $item)
                    ...
                    <td id="contenido">{{ $item->programa_id}}</td>
                    <td id="contenido" style="text-align:center">{{ $item->semestre}}</td>
