                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h5 class="m-0">Búsqueda de estudiantes</h5>
                            </div>
                            <div class="card-body">
                            <form class="form-inline" id="formulario-busqueda">
                                    ...
                                    <a href="{{route('estudiante.pdf')}}"class="btn btn-danger" target="_blank" style='width:80px; height:50px'><i class='nav-icon fas fa-file-pdf fa-2x'></i></a>
                                    </ul> 
                                </form>
                            </div>
                        </div>
