<div class="modal-header">
    <h4 class="modal-title">Editar docentes</h4>
</div>
<form action="" id="formulario-editar" autocomplete="off">
    ...
    <div class="modal-body">
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <select name="programa_id" id="programa_id" class="form-control">
                    ...
                    @foreach ($programa_docente as $programa)
        ...
        <div class="form-group row">
            <label class="col-sm-6 col-form-label" for="especialidad">especialidad</label>
            <div class="col-sm-8">
                <input type="text" name="especialidad" id="especialidad" class="form-control" value="{{ $item->especialidad}}" />
            </div>
        </div>
