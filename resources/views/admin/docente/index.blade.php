                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <form class="form-inline" id="formulario-busqueda">
                                    ...
                                    class="btn btn-success my-1 mx-1">Nuevo</button>
                                        class="btn btn-success my-1 mx-1"><i class='fa fa-user-plus fa-2x'></i></button>
                                    <a href="{{route('docente.pdf')}}"class="btn btn-danger" target="_blank" style='width:80px; height:50px'><i class='nav-icon fas fa-file-pdf fa-2x'></i></a>
                                    </ul> 
                                </form>
                            </div>
                        </div>
