<div style="border-style:outsed;font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;width: 540px; height: 570px; background:linear-gradient(rgba(225,209,213),#6b1b31);color">
<div class="modal-header">
    <h4 class="modal-title">Registrar Prestamistas</h4>
</div>
...
<div class="modal-body">
        ...
        <div class="form-group row">
            <label class="col-sm-4 col-form-label" for="nombre_completo">Nombre :</label>
            <div class="col-sm-8">
