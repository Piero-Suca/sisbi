                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            ...
                            <form class="form-inline" id="formulario-busqueda">
                                    ...
                                    <button type="submit" class="btn btn-primary my-1"><i class='fa fa-search fa-2x'></i></button>
                                    <button onclick="modalCrear()" type="button" class="btn btn-success my-1 mx-1"><i class='fa fa-user-plus fa-2x'></i></button>
