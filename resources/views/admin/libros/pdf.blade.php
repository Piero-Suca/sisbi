...
<header>
    ...
    <div class="container">
        ...
        <table id="tabla">
            <thead>
                <tr >
                <th class="center" style="font-weight:bold; border:1px solid #1d1d1d;background-color: #03a9f4;color:#fff" width="5%">Orden de Libros</th>
                    ...
                    <th class="center" style="font-weight:bold; border:1px solid #1d1d1d;background-color: #03a9f4;color:#fff" width="5%">Stock</th>
                    <th class="center" style="font-weight:bold; border:1px solid #1d1d1d;background-color: #03a9f4;color:#fff" width="5%">fecha Ingreso</th>
            ...
            <tbody>
                @foreach ($libros as $item)
                    <tr id="contenido">
                        <td id="contenido">{{ $item->orden_libro }}</td>
                        <td id="contenido">{{ $item->titulo }}</td>
                        <td id="contenido">{{ $item->autor}}</td>
                        <td id="contenido">{{ $item->Stock}}</td>
                        <td id="contenido">{{ $item->fecha_ingreso}}</td>
