<div style="border-style:outsed;font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;width: 600px; height: 540px; background:linear-gradient(rgba(225,209,213),#6b1b31);color">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <select name="cod_programa" id="cod_programa" class="form-control">
                    ...
                    @foreach ($programa_revista as $programa)
