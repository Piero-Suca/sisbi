                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h5 class="m-0">Búsqueda de Revistas</h5>
                            </div>
                            <div class="card-body">
                            <form class="form-inline" id="formulario-busqueda">
                                    ...
                                    <a href="{{route('revista.pdf')}}"class="btn btn-danger" target="_blank" style='width:60px; height:40px;background-color:#0a0a0a'><i class='fas fa-file-pdf fa-lg'></i></a>
                                    <a href="{{route('revista.csv') }}"type="button" class="btn btn-success my-1 mx-1" style='width:60px; height:40px; background-color:#0a0a0a'><i class='fas fa-file-csv fa-lg'></i></a>
                                    <a href="{{route('revista.excel')}}"class="btn btn-danger" target="_blank" style='width:60px; height:40px; background-color:#0a0a0a'><i class='fas fa-file-excel fa-lg'></i></a>
                                    <a href="{{route('revista.html') }}"type="button" class="btn btn-success my-1 mx-1"style='width:60px; height:40px; background-color:#0a0a0a'><i class='fa fa-clone fa-lg'></i></a>
                                    </div>
                                </ul> 
                                </form>
                            </div>
...
@section('javascript')
    <script>
        ...
        function search() {
            ...
            const ruta = route('revista.search');
        ...
        function modalCrear() {
            const ruta = route("revista.create");
        ...
        function guardar() {
            const ruta = route('revista.store');
        ...
        function modalEditar(id) {
            const ruta = route('revista.edit', [id]);
        ...
        function actualizar(id) {
            const ruta = route('revista.update', [id]);
        ...
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const ruta = route('revista.destroy', [id]);
